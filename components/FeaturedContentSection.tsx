        ...
        <div className="overflow-hidden" ref={emblaRef}>
          <div className="flex">
            {articles.map((article) => (
              ...
              >
                <article
                  className="bg-white rounded-3xl overflow-hidden cursor-pointer h-[530px] flex flex-col relative group card-hover focus-within:ring-2 focus-within:ring-gt-purple focus-within:ring-offset-2"
                >
