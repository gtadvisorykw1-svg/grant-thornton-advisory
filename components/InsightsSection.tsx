...
export function InsightsSection() {
  return (
    <section className="py-20 md:py-28 bg-gt-gray-light" aria-labelledby="insights-heading">
      <div className="max-w-6xl mx-auto px-4 md:px-8">
        {/* Header */}
        <ScrollReveal>
          <div className="mb-4">
            <span className="text-gt-purple text-sm font-medium uppercase tracking-wider">
        ...
        <ScrollReveal variant="fadeUp" delay={0.3}>
          <div className="text-center">
            <a
              ...
              className="inline-flex items-center gap-2 px-8 py-3 bg-gt-coral text-white font-medium rounded hover:bg-gt-coral-hover transition-all duration-500 btn-hover-lift focus:outline-none focus-visible:ring-2 focus-visible:ring-gt-coral focus-visible:ring-offset-2"
            >
