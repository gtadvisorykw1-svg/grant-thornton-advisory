...
export function CareerSection() {
  return (
    <section className="relative h-[500px] lg:h-[600px] overflow-hidden">
      ...
      {/* Content */}
      <div className="relative container mx-auto px-4 lg:px-16 h-full flex flex-col justify-center">
        <div className="max-w-2xl">
          ...
          <a
            href="/Careers/"
            className="inline-flex items-center gap-2 px-10 py-4 border border-white rounded text-white bg-transparent hover:bg-white/10 transition-all duration-500 group"
          >
