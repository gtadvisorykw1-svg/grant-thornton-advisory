  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main role="main" aria-label={`${title} industry page`}>
        {/* Hero Section */}
        <section className="bg-gradient-to-br from-gt-purple to-gt-purple-dark text-white" aria-labelledby="industry-title">
          <div className="max-w-6xl mx-auto px-4 md:px-8 py-16 md:py-24">
            ...
            >
              {tagline && (
                <span className="label-text text-gt-coral mb-2 block">{tagline}</span>
              )}
          ...
          <div className="max-w-6xl mx-auto px-4 md:px-8">
            <ScrollReveal>
              <div className="grid md:grid-cols-2 gap-12 items-start">
                <div>
                  <h2 id="why-gt-heading" className="heading-lg text-gt-purple mb-6">
                  ...
                  {readMore && (
                    <div className="mt-6">
                      <button
                        ...
                        className="flex items-center text-gt-coral font-medium hover:text-gt-coral-hover transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-gt-purple rounded"
                ...
                <div className="relative aspect-[4/3] rounded-lg overflow-hidden bg-gray-100">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-gt-purple/20 to-transparent" />
                </div>
              </div>
            </ScrollReveal>
          </div>
        ...
        {/* Insights Section */}
        <section className="py-16 md:py-24 bg-gt-gray-light" aria-labelledby="insights-heading">
          <div className="max-w-6xl mx-auto px-4 md:px-8">
            <ScrollReveal>
              <h2 id="insights-heading" className="heading-lg text-gt-purple mb-6">
                Insights
              </h2>
              ...
              <Link
                ...
                className="inline-flex items-center text-gt-coral font-medium hover:text-gt-coral-hover transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-gt-purple rounded"
              >
                View all insights
