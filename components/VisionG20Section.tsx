...
export function VisionG20Section() {
  return (
    <section className="grid grid-cols-1 lg:grid-cols-2">
      ...
      <div className="doing-business-card relative px-8 lg:px-16 py-20 lg:py-24 bg-gt-purple overflow-hidden">
        ...
        <div className="relative z-10 max-w-lg">
          ...
          <a
            ...
            className="doing-business-btn inline-flex items-center gap-3 px-8 py-4 rounded bg-transparent text-white text-base font-medium border-2 border-white transition-all duration-500 hover:bg-white hover:text-gt-purple group"
          >
      ...
      <div className="insights-card relative px-8 lg:px-16 py-20 lg:py-24 bg-gt-gray-light overflow-hidden">
        ...
        <div className="relative z-10 max-w-lg">
          {/* Label */}
          <span className="inline-block px-4 py-1.5 rounded-full text-sm font-medium mb-6 text-gt-purple bg-white border border-gt-purple/20">
            Insights
          </span>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="insights-btn inline-flex items-center gap-3 px-8 py-4 rounded text-white text-base font-medium bg-gt-coral border-2 border-gt-coral transition-all duration-500 hover:bg-gt-coral-hover hover:border-gt-coral-hover group"
          >
