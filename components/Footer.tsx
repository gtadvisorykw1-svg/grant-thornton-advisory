      ...
      <div className="max-w-[1172px] mx-auto px-4 sm:px-6">
            ...
            <ul className="space-y-2 sm:space-y-3" role="list">
              {footerLinks.connect.map((link) => (
                <li key={link.label}>
                  <Link
                    href={link.href}
                    className="text-white text-sm sm:text-base hover:underline transition-all duration-500 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-gt-purple rounded px-1 -mx-1"
                  >
                    {link.label}
                  </Link>
                </li>
                ...
                <li key={link.label}>
                  {link.external ? (
                    <a
                      ...
                      className="text-white text-sm sm:text-base hover:underline transition-all duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-gt-purple rounded px-1 -mx-1"
                    >
                      {link.label}
                    </a>
                  ) : (
            ...
            <ul className="flex items-center gap-2 sm:gap-3" role="list" aria-labelledby="footer-social">
              <li>
                <a
                  ...
                  className="w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-white flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-gt-purple"
                >
                  <Youtube className="w-4 h-4 sm:w-5 sm:h-5 text-gt-purple transition-all duration-300" aria-hidden="true" />
                </a>
              </li>
              <li>
                <a
        ...
        <div className="mt-12 sm:mt-16 pt-8 sm:pt-10 border-t border-white/20">
          <p className="text-white text-xs sm:text-sm leading-relaxed">
            © {new Date().getFullYear()} Grant Thornton Kuwait - All rights reserved. &quot;Grant Thornton&quot; refers to the brand under which the Grant Thornton member firms provide assurance, tax and advisory services to their clients and/or refers to one or more member firms, as the context requires. GTIL and the member firms are not a worldwide partnership. GTIL and each member firm is a separate legal entity. Services are delivered by the member firms. GTIL does not provide services to clients. GTIL and its member firms are not agents of, and do not obligate, one another and are not liable for one another&apos;s acts or omissions.
          </p>
        </div>
      </div>
    </footer>
