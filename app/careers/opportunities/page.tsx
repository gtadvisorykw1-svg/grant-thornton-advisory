  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main role="main" aria-label="Career opportunities page">
        {/* Hero Section */}
        <section className="bg-gradient-to-br from-gt-purple to-gt-purple-dark text-white" aria-labelledby="opportunities-title">
          <div className="max-w-6xl mx-auto px-4 md:px-8 py-16 md:py-20">
            ...
            >
              <span className="label-text text-gt-coral mb-2 block">OPEN POSITIONS</span>
        ...
        {/* Search and Filters */}
        <section className="py-8 bg-gt-gray-light sticky top-20 z-30 border-b border-gray-200">
              ...
              <button
                ...
                className={`inline-flex items-center justify-center px-6 py-3 rounded-lg border transition-all ${
                  showFilters || hasActiveFilters
                    ? 'bg-gt-purple text-white border-gt-purple'
                    : 'bg-white text-gray-700 border-gray-300 hover:border-gt-purple'
                }`}
              >
                <Filter className="h-5 w-5 mr-2" />
                Filters
                {hasActiveFilters && (
                  <span className="ml-2 w-5 h-5 bg-gt-coral text-white text-xs rounded-full flex items-center justify-center">
                    !
                  </span>
                )}
              </button>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4 pt-4 border-t border-gray-200">
                    ...
                    <div className="relative">
                      ...
                      <select
                        ...
                        className="w-full px-4 py-2 rounded-lg border border-gray-300 focus:border-gt-purple focus:ring-2 focus:ring-gt-purple/20 outline-none appearance-none bg-white"
                      >
                  ...
                  {hasActiveFilters && (
                    <div className="mt-4 flex justify-end">
                      <button
                        ...
                        className="inline-flex items-center text-sm text-gt-coral hover:text-gt-coral-hover transition-colors"
                      >
        ...
        <section className="py-12 md:py-16" aria-labelledby="listings-heading">
          <div className="max-w-6xl mx-auto px-4 md:px-8">
            <div className="flex items-center justify-between mb-8">
              <h2 id="listings-heading" className="heading-md text-gt-purple">
            ...
            {filteredJobs.length > 0 ? (
                  ...
                  <StaggerItem key={job.id}>
                    <div 
                      className={`bg-white rounded-xl border transition-all duration-300 ${
                        expandedJob === job.id 
                          ? 'border-gt-purple shadow-lg' 
                          : 'border-gray-200 hover:border-gt-purple/50 hover:shadow-md'
                      }`}
                    >
                      {/* Job Header */}
                      <button
                      ...
                      >
                        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                          <div>
                            <h3 className="heading-sm text-gt-purple mb-2">
                              {job.title}
                            </h3>
                          ...
                          <div className="flex items-center gap-3">
                            <span className="px-3 py-1 bg-gt-gray-light rounded-full text-sm text-gray-700">
                              {job.type}
                            </span>
                            <span className="px-3 py-1 bg-gt-purple/10 rounded-full text-sm text-gt-purple">
                              {job.level}
                            </span>
                            <ChevronDown 
                            ...
                            <div className="px-6 pb-6 border-t border-gray-100">
                              <div className="pt-6 grid md:grid-cols-3 gap-6">
                                <div className="md:col-span-2">
                                  <h4 className="font-medium text-gt-purple mb-2">Description</h4>
                                  <p className="body-md text-gray-600 mb-6">{job.description}</p>
                                  
                                  <h4 className="font-medium text-gt-purple mb-2">Requirements</h4>
                                  <ul className="space-y-2">
                                    {job.requirements.map((req, idx) => (
                                      <li key={idx} className="flex items-start gap-2 text-gray-600">
                                        <span className="w-1.5 h-1.5 bg-gt-coral rounded-full mt-2 shrink-0" />
                                        {req}
                                      </li>
                                    ))}
                                  </ul>
                                </div>
                                <div className="bg-gt-gray-light rounded-xl p-6">
                                  <h4 className="font-medium text-gt-purple mb-4">Apply Now</h4>
                                  ...
                                  <Link
                                    ...
                                    className="inline-flex items-center justify-center w-full px-6 py-3 bg-gt-coral text-white font-medium rounded hover:bg-gt-coral-hover transition-all"
                                  >
                                  ...
                                  <p className="body-sm text-gray-500 mt-4 text-center">
                                    or email{' '}
                                    <a href="mailto:info@advisory.kw.gt.com" className="text-gt-purple hover:underline">
              ...
              <ScrollReveal>
                <div className="text-center py-16 bg-gt-gray-light rounded-2xl">
                  ...
                  <button
                    onClick={clearFilters}
                    className="inline-flex items-center px-6 py-3 bg-gt-purple text-white font-medium rounded hover:bg-gt-purple-dark transition-all"
                  >
                    Clear all filters
                  </button>
                </div>
        ...
        <section className="py-16 md:py-24 bg-gt-gray-light" aria-labelledby="speculative-heading">
          <div className="max-w-6xl mx-auto px-4 md:px-8">
            <ScrollReveal>
              <div className="bg-white rounded-2xl p-8 md:p-12 text-center">
                <h2 id="speculative-heading" className="heading-lg text-gt-purple mb-4">
