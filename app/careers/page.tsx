  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main role="main" aria-label="Careers page">
        ...
        <section className="relative min-h-[600px] lg:min-h-[700px] overflow-hidden" aria-labelledby="careers-title">
          ...
          <div className="relative max-w-6xl mx-auto px-4 md:px-8 py-16 md:py-24 h-full flex flex-col justify-center">
            ...
            <motion.div
              ...
              className="max-w-3xl"
            >
              <span className="label-text text-gt-coral mb-2 block">CAREERS</span>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  ...
                  className="inline-flex items-center justify-center px-8 py-4 bg-gt-coral text-white font-medium rounded btn-hover-lift hover:bg-gt-coral-hover transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-gt-purple"
                >
                  View Open Positions
        ...
        <section className="py-16 md:py-24 bg-gt-gray-light" aria-labelledby="values-heading">
          <div className="max-w-6xl mx-auto px-4 md:px-8">
            <ScrollReveal>
              <div className="text-center mb-12">
                <span className="label-text text-gt-coral mb-2 block">THE GRANT THORNTON DIFFERENCE</span>
                <h2 id="values-heading" className="heading-xl text-gt-purple mb-4">
                  Our CLEARR Values
                </h2>
            ...
            <StaggerContainer className="grid md:grid-cols-2 lg:grid-cols-3 gap-6" staggerDelay={0.1}>
              {clearrValues.map((value, index) => (
                <StaggerItem key={index}>
                  <div className="bg-white rounded-xl p-6 h-full card-hover border border-transparent hover:border-gt-purple">
                    <div className="flex items-start gap-4">
                      <div className="w-14 h-14 bg-gt-purple rounded-lg flex items-center justify-center shrink-0">
                        <span className="text-2xl font-bold text-white">{value.letter}</span>
                      </div>
                      <div>
                        <h3 className="heading-md text-gt-purple mb-2">{value.title}</h3>
        ...
        <section className="py-16 md:py-24" aria-labelledby="tracks-heading">
          <div className="max-w-6xl mx-auto px-4 md:px-8">
            <ScrollReveal>
              <div className="text-center mb-12">
                <span className="label-text text-gt-coral mb-2 block">CAREER OPPORTUNITIES</span>
                <h2 id="tracks-heading" className="heading-xl text-gt-purple mb-4">
                  Find Your Path
                </h2>
                <p className="body-lg text-gray-600 max-w-2xl mx-auto">
              ...
              {careerTracks.map((track, index) => (
                <StaggerItem key={index}>
                  <Link href={track.href} className="block h-full group">
                      <div className="bg-white rounded-2xl overflow-hidden h-full border border-gray-200 hover:border-gt-purple hover:shadow-xl transition-all duration-300">
                        ...
                        <ul className="space-y-2 mb-6">
                          {track.features.map((feature, idx) => (
                            <li key={idx} className="flex items-center gap-2 text-sm text-gray-700">
                              <CheckCircle className="h-4 w-4 text-gt-coral" />
                              {feature}
                            </li>
                          ))}
                        </ul>
                        <div className="flex items-center text-gt-purple font-medium group-hover:text-gt-coral transition-colors">
                          Learn more
          ...
          <div className="max-w-6xl mx-auto px-4 md:px-8">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <ScrollReveal variant="fadeRight">
                <div>
                  <span className="label-text text-gt-coral mb-2 block">LIFE AT GRANT THORNTON</span>
                  <h2 id="life-heading" className="heading-xl text-gt-purple mb-6">
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    {benefits.map((benefit, index) => (
                      <div key={index} className="flex items-start gap-3">
                        <div className="w-10 h-10 bg-gt-gray-light rounded-lg flex items-center justify-center shrink-0">
                          <benefit.icon className="h-5 w-5 text-gt-purple" />
                        </div>
                        <div>
                          <h3 className="font-medium text-gt-purple mb-1">{benefit.title}</h3>
              ...
              <ScrollReveal variant="fadeLeft">
                <div className="relative">
                  <div className="aspect-[4/3] bg-gt-gray-light rounded-2xl overflow-hidden">
                    <Image
                      src="/career.jpg"
                  ...
                  {/* Decorative element */}
                  <div className="absolute -bottom-6 -left-6 w-32 h-32 bg-gt-purple rounded-2xl -z-10" />
                  <div className="absolute -top-6 -right-6 w-24 h-24 bg-gt-coral rounded-2xl -z-10" />
                </div>
              </ScrollReveal>
            </div>
          </div>
        ...
        {/* Testimonials */}
        <section className="py-16 md:py-24 bg-gt-gray-light" aria-labelledby="testimonials-heading">
          <div className="max-w-6xl mx-auto px-4 md:px-8">
            <ScrollReveal>
              <div className="text-center mb-12">
                <span className="label-text text-gt-coral mb-2 block">OUR PEOPLE</span>
                <h2 id="testimonials-heading" className="heading-xl text-gt-purple mb-4">
                  Hear From Our Team
                </h2>
              </div>
            </ScrollReveal>
              ...
              {testimonials.map((testimonial, index) => (
                <StaggerItem key={index}>
                  <div className="bg-white rounded-2xl p-8 h-full flex flex-col">
                    <div className="mb-6">
                      <svg className="h-8 w-8 text-gt-purple/20" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="border-t border-gray-100 pt-6">
                      <p className="font-medium text-gt-purple">{testimonial.name}</p>
                      <p className="body-sm text-gray-600">{testimonial.role}</p>
                      <p className="body-sm text-gt-coral">{testimonial.years}</p>
                    </div>
                  </div>
                </StaggerItem>
              ))}
        ...
        <section className="py-16 md:py-24" aria-labelledby="global-heading">
          <div className="max-w-6xl mx-auto px-4 md:px-8">
            <ScrollReveal>
              <div className="bg-gradient-to-br from-gt-purple to-gt-purple-dark rounded-2xl p-8 md:p-12">
                <div className="grid lg:grid-cols-2 gap-8 items-center">
                  <div>
                    <div className="flex items-center gap-3 mb-4">
                      <Globe className="h-8 w-8 text-gt-coral" />
                    ...
                    <a
                      ...
                      className="inline-flex items-center text-white font-medium hover:text-gt-coral transition-colors"
                    >
        ...
        {/* CTA Section */}
        <section className="py-16 md:py-24 bg-gt-gray-light" aria-labelledby="cta-heading">
          <div className="max-w-6xl mx-auto px-4 md:px-8">
            <ScrollReveal variant="scale">
              <div className="text-center">
                <h2 id="cta-heading" className="heading-xl text-gt-purple mb-4">
                  Ready to Go Beyond?
                </h2>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Link
                    href="/careers/opportunities"
                    className="inline-flex items-center justify-center px-8 py-4 bg-gt-coral text-white font-medium rounded btn-hover-lift hover:bg-gt-coral-hover transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-gt-coral focus-visible:ring-offset-2"
                  >
                    View Open Positions
                    <ArrowRight className="ml-2 h-5 w-5" aria-hidden="true" />
                  </Link>
                  <Link
                    href="/careers/apply"
                    className="inline-flex items-center justify-center px-8 py-4 bg-gt-purple text-white font-medium rounded btn-hover-lift hover:bg-gt-purple-dark transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-gt-purple focus-visible:ring-offset-2"
                  >
                    Submit Your CV
                    <ArrowRight className="ml-2 h-5 w-5" aria-hidden="true" />
                  </Link>
                ...
                <p className="body-sm text-gray-500 mt-6">
                  ...
                  <a href="mailto:info@advisory.kw.gt.com" className="text-gt-purple hover:text-gt-coral underline">
      ...
      {showVideo && (
        ...
        >
          <div className="relative max-w-4xl w-full aspect-video">
            <button
              onClick={() => setShowVideo(false)}
              className="absolute -top-12 right-0 text-white hover:text-gt-coral transition-colors"
