  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main role="main" aria-label="Leadership page">
        {/* Hero Section */}
        <section className="bg-gradient-to-br from-gt-purple to-gt-purple-dark text-white" aria-labelledby="leadership-title">
          <div className="max-w-6xl mx-auto px-4 md:px-8 py-16 md:py-24">
            ...
            >
              <span className="label-text text-gt-coral mb-2 block">Our Leadership</span>
                ...
                <ScrollReveal key={leader.name}>
                  <div className={`grid md:grid-cols-2 gap-8 md:gap-12 items-start ${index % 2 === 1 ? 'md:flex-row-reverse' : ''}`}>
                    ...
                    <div className={`${index % 2 === 1 ? 'md:order-1' : ''}`}>
                      <span className="label-text text-gt-coral mb-2 block">{leader.title}</span>
                      <h3 className="heading-lg text-gt-purple mb-4">{leader.name}</h3>
                      ...
                      {/* Quote */}
                      <div className="mt-6 bg-gt-gray-light rounded-xl p-6 relative">
                        <Quote className="absolute top-4 left-4 h-8 w-8 text-gt-purple/20" />
        ...
        {/* Our Team Section */}
        <section className="py-16 md:py-24 bg-gt-gray-light" aria-labelledby="team-heading">
          <div className="max-w-6xl mx-auto px-4 md:px-8">
            <ScrollReveal>
              <div className="text-center max-w-3xl mx-auto">
                <div className="w-16 h-16 bg-gt-purple rounded-full flex items-center justify-center mx-auto mb-6">
                  <Users className="h-8 w-8 text-white" />
                </div>
                <h2 id="team-heading" className="heading-lg text-gt-purple mb-4">
                  Our Team
                </h2>
