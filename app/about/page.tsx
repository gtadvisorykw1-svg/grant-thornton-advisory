  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main role="main" aria-label="About us page">
        {/* Hero Section */}
        <section className="bg-gradient-to-br from-gt-purple to-gt-purple-dark text-white" aria-labelledby="about-title">
          <div className="max-w-6xl mx-auto px-4 md:px-8 py-16 md:py-24">
            ...
            >
              <span className="label-text text-gt-coral mb-2 block">Who We Are</span>
              ...
              <div className="grid md:grid-cols-2 gap-12 items-center">
                <div>
                  <div className="flex items-center gap-3 mb-4">
                    <Globe className="h-8 w-8 text-gt-purple" />
                    <h2 id="global-strength-heading" className="heading-lg text-gt-purple">
                      Our Global Strength
                    </h2>
                  </div>
                ...
                <div className="bg-gt-gray-light rounded-2xl p-8">
                  <h3 className="heading-md text-gt-purple mb-6">By the Numbers</h3>
                  <div className="grid grid-cols-2 gap-4">
                    {stats.map((stat, index) => (
                      <div key={index} className="text-center p-4 bg-white rounded-lg">
                        <div className="heading-md text-gt-coral mb-1">{stat.value}</div>
        ...
        <section className="py-16 md:py-24 bg-gt-gray-light" aria-labelledby="difference-heading">
          <div className="max-w-6xl mx-auto px-4 md:px-8">
            <ScrollReveal>
              <div className="max-w-3xl">
                <div className="flex items-center gap-3 mb-4">
                  <Award className="h-8 w-8 text-gt-purple" />
                  <h2 id="difference-heading" className="heading-lg text-gt-purple">
                    What Sets Us Apart
                  </h2>
                </div>
          ...
          <div className="max-w-6xl mx-auto px-4 md:px-8">
            <ScrollReveal>
              <div className="flex items-center gap-3 mb-8">
                <Building2 className="h-8 w-8 text-gt-purple" />
                <h2 id="services-heading" className="heading-lg text-gt-purple">
            ...
            <StaggerContainer className="grid md:grid-cols-2 lg:grid-cols-3 gap-4" staggerDelay={0.05}>
              {services.map((service, index) => (
                <StaggerItem key={index}>
                  <div className="flex items-start gap-3 p-4 bg-white border border-gray-200 rounded-lg hover:border-gt-purple hover:shadow-md transition-all">
                    <CheckCircle className="h-5 w-5 text-gt-coral mt-0.5 shrink-0" />
            ...
            <ScrollReveal>
              <div className="mt-8 text-center">
                <Link
                  href="/services"
                  className="inline-flex items-center text-gt-coral font-medium hover:text-gt-coral-hover transition-colors"
                >
                  View all services
