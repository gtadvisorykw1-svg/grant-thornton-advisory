  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main role="main" aria-label="Mission and values page">
        {/* Hero Section */}
        <section className="bg-gradient-to-br from-gt-purple to-gt-purple-dark text-white" aria-labelledby="mission-title">
          <div className="max-w-6xl mx-auto px-4 md:px-8 py-16 md:py-24">
            ...
            >
              <span className="label-text text-gt-coral mb-2 block">Our Mission & Values</span>
          ...
          <div className="max-w-6xl mx-auto px-4 md:px-8">
            <ScrollReveal>
              <div className="grid md:grid-cols-2 gap-12">
                <div className="bg-gt-gray-light rounded-2xl p-8">
                  <div className="flex items-center gap-3 mb-4">
                    <Target className="h-8 w-8 text-gt-coral" />
                    <h2 id="mission-heading" className="heading-lg text-gt-purple">
                      Our Mission
                    </h2>
                  </div>
                ...
                <div className="bg-gt-purple rounded-2xl p-8 text-white">
                  <div className="flex items-center gap-3 mb-4">
                    <Lightbulb className="h-8 w-8 text-gt-coral" />
        ...
        <section className="py-16 md:py-24 bg-gt-gray-light" aria-labelledby="unique-heading">
          <div className="max-w-6xl mx-auto px-4 md:px-8">
            <ScrollReveal>
              <h2 id="unique-heading" className="heading-lg text-gt-purple mb-8 text-center">
              ...
              {whatMakesUsUnique.map((item, index) => (
                <StaggerItem key={index}>
                  <div className="bg-white rounded-xl p-6 h-full text-center card-hover">
                    <div className="w-16 h-16 bg-gt-purple rounded-full flex items-center justify-center mx-auto mb-4">
                      <item.icon className="h-8 w-8 text-white" />
                    </div>
                    <h3 className="heading-md text-gt-purple mb-3">{item.title}</h3>
        ...
        <section className="py-16 md:py-24" aria-labelledby="values-heading">
          <div className="max-w-6xl mx-auto px-4 md:px-8">
            <ScrollReveal>
              <h2 id="values-heading" className="heading-lg text-gt-purple mb-8 text-center">
                Our Core Values
              </h2>
            </ScrollReveal>
            ...
            <StaggerContainer className="grid md:grid-cols-2 lg:grid-cols-3 gap-6" staggerDelay={0.1}>
              {coreValues.map((value, index) => (
                <StaggerItem key={index}>
                  <div className="border border-gray-200 rounded-xl p-6 h-full hover:border-gt-purple hover:shadow-lg transition-all">
                    <div className="flex items-center gap-3 mb-4">
                      <div className="w-12 h-12 bg-gt-coral rounded-lg flex items-center justify-center">
                        <value.icon className="h-6 w-6 text-white" />
                      </div>
                      <h3 className="heading-md text-gt-purple">{value.title}</h3>
                    </div>
        ...
        <section className="py-16 md:py-24 bg-gt-gray-light" aria-labelledby="cta-heading">
          <div className="max-w-6xl mx-auto px-4 md:px-8">
            <ScrollReveal variant="scale">
              <div className="bg-gradient-to-br from-gt-purple to-gt-purple-dark rounded-2xl p-8 md:p-12 text-center">
                ...
                <Link
                  ...
                  className="inline-flex items-center px-8 py-3 bg-gt-coral text-white font-medium rounded btn-hover-lift hover:bg-gt-coral-hover transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-gt-purple"
                >
                  Contact Us
