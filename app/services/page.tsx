...
export default function ServicesPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <main>
        {/* Hero Section */}
        <section className="bg-gradient-to-br from-gt-purple to-gt-purple-dark text-white">
        ...
        <section className="py-16 md:py-24">
          <div className="max-w-6xl mx-auto px-4 md:px-8">
            <div className="mb-12">
              <span className="label-text text-gt-coral mb-2 block">Service Line</span>
              <h2 className="heading-xl text-gt-purple mb-4">Operational Advisory</h2>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {operationalAdvisoryServices.map((service) => (
                <Link
                  key={service.title}
                  href={service.href}
                  className="block p-8 rounded-3xl h-full card-hover bg-white shadow-[0_4px_20px_rgb(0,0,0,0.06)] group focus:outline-none focus-visible:ring-2 focus-visible:ring-gt-purple focus-visible:ring-offset-2 transition-all duration-500"
                >
                  <h3 className="mb-4">
                    <span className="text-2xl font-normal transition-colors duration-500 group-hover:text-gt-coral text-gt-purple">
                      {service.title}
                    </span>
                  </h3>
                  ...
                  <div className="flex flex-wrap gap-2 mb-6">
                    {service.features.map((feature) => (
                      <span
                        key={feature}
                        className="text-xs bg-gt-gray-light text-gray-600 px-2 py-1 rounded"
                      >
                        {feature}
                      </span>
                    ))}
                  </div>
                  <span className="inline-flex items-center text-sm font-medium text-gt-purple group-hover:text-gt-coral transition-colors duration-500">
                    Learn more
        ...
        <section className="py-16 md:py-24 bg-gt-gray-light">
          <div className="max-w-6xl mx-auto px-4 md:px-8">
            <div className="mb-12">
              <span className="label-text text-gt-coral mb-2 block">Service Line</span>
              <h2 className="heading-xl text-gt-purple mb-4">Transaction Advisory</h2>
              <p className="body-lg text-gray-600 max-w-3xl">
                ...
                >
                  ...
                  <div className="flex flex-wrap gap-2 mb-6">
                    {service.features.map((feature) => (
                      <span
                        key={feature}
                        className="text-xs bg-gt-purple/10 text-gt-purple px-2 py-1 rounded"
                      >
                        {feature}
                      </span>
                    ))}
          ...
          <div className="max-w-6xl mx-auto px-4 md:px-8">
            <div className="bg-gradient-to-br from-gt-purple to-gt-purple-dark rounded-2xl p-8 md:p-12 text-center">
              ...
              <Link
                ...
                className="inline-flex items-center px-8 py-3 bg-gt-coral text-white font-medium rounded hover:bg-gt-coral-hover transition-colors"
              >
                Contact Us
